    ...
    *************************************************************/
    renderRow(searchTerm) {
        return (React.createElement(View, { style: styles.row },
            React.createElement(Text, { style: styles.boldLabel }, searchTerm)));
    }
    /* ***********************************************************
    ...
    *************************************************************/
    ...
    render() {
        return (React.createElement(View, { style: styles.container },
            ...
            React.createElement(ListView, { contentContainerStyle: styles.listContent, dataSource: this.state.dataSource, renderRow: this.renderRow, pageSize: 15, enableEmptySections: true })));
    }
}
...
//# sourceMappingURL=ListviewSearchingExample.js.map