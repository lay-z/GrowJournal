...
class MapviewExample extends React.Component {
    ...
    *************************************************************/
    ...
    renderMapMarkers(location) {
        ...
        *************************************************************/
        return (React.createElement(MapView.Marker, { key: location.title, coordinate: { latitude: location.latitude, longitude: location.longitude } },
            React.createElement(MapCallout, { location: location, onPress: this.calloutPress })));
    }
    render() {
        return (React.createElement(View, { style: Styles.container },
            React.createElement(MapView, { style: Styles.map, initialRegion: this.state.region, onRegionChangeComplete: this.onRegionChange, showsUserLocation: this.state.showUserLocation }, this.state.locations.map((location) => this.renderMapMarkers(location)))));
    }
}
...
//# sourceMappingURL=MapviewExample.js.map