...
class CustomNavBar extends React.Component {
  ...
  renderMiddle () {
    ...
    if (this.state.showSearchBar) {
      ...
      return (
        <View>
          <Image resizeMode='center' style={styles.logo} source={Images.growJournalLogo} />
...
export const renderTitle = (navBarProps: Object) => {
  return (
    <View>
      <Image resizeMode='center' style={styles.logo} source={Images.growJournalLogo} />
      <Text style={styles.title}>{navBarProps.title}</Text>
    </View>
  )
}
