...
let globalExamplesRegistry: JSX.Element[] = []

export const addExample = (title: string, usage: () => JSX.Element) => { if (DebugSettings.includeExamples) globalExamplesRegistry.push({title, usage}) }
